# This is an example to use dinov2. This script takes in two images, compute their DINOv2 features, and calculate the cosine similarity between their image patches.
...
if __name__ == "__main__":
    ...
    for dataset in ["libero_10", "libero_90", "libero_goal", "libero_object", "libero_spatial"]:
        ...
        for dataset_name in dataset_name_list:
            ...
            embedding_name = f"/public/home/group_luoping/leiyuheng/dataset/datasets/lotus/dinov2/{part_2}/{part_1}"
            ...
            for i in range(demo_num):
                ...
                embeddings = agentview_features.cpu().unsqueeze(1).numpy().astype('float32') 
