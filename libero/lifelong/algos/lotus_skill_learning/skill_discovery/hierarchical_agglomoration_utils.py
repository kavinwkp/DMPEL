...
def save_agglomorative_tree(agglomorative_tree, agentview_images, ep_idx, exp_name, dataset_name, footprint_mode, dist_mode, modality_mode):
        ...
        for agglomorative_tree_node in agglomorative_tree.nodes:
            if agglomorative_tree_node.children_node_indices == []:
                if counter % 1 == 0: # Only plot every 3th image
                    ...
                    img = agentview_images[agglomorative_tree_node.centroid_idx]
        ...
        os.makedirs(f"/mnt/petrelfs/leiyuheng/project/LIBERO-master/lotus_results/{exp_name}/skill_classification/agglomoration_results/{dataset_name}/{footprint_mode}_{dist_mode}_{modality_mode}", exist_ok=True)
        cv2.imwrite(f"/mnt/petrelfs/leiyuheng/project/LIBERO-master/lotus_results/{exp_name}/skill_classification/agglomoration_results/{dataset_name}/{footprint_mode}_{dist_mode}_{modality_mode}/{ep_idx}.png", image)
