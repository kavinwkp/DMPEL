...
def main(hydra_cfg):
    ...
    for exp_name in ['dinov2_libero_object_image_only', 
                     'dinov2_libero_spatial_image_only',
                     'dinov2_libero_goal_image_only',
                     'dinov2_libero_10_image_only',
                     'dinov2_libero_90_image_only']:

        exp_dir = f"/public/home/group_luoping/leiyuheng/dataset/datasets/lotus/{exp_name}/repr"
        dataset_name_list = []
        ...
        for dataset_name in dataset_name_list:
            ...
            dir_name = f"/public/home/group_luoping/leiyuheng/dataset/datasets/lotus/{exp_name}/skill_classification/trees/{dataset_category}"
            ...
            embedding_hdf5_path = f"/public/home/group_luoping/leiyuheng/dataset/datasets/lotus/{exp_name}/repr/{dataset_name}/embedding_{modality_str}_{cfg.repr.z_dim}.hdf5"
            embedding_h5py_f = h5py.File(embedding_hdf5_path, "r")
        
            total_len = 0

            try:
                shutil.rmtree(f"/public/home/group_luoping/leiyuheng/dataset/datasets/lotus/{exp_name}/skill_classification/initial_clustering")
            except:
                pass
            ...
            with open(f"/public/home/group_luoping/leiyuheng/dataset/datasets/lotus/{exp_name}/skill_classification/trees/{dataset_name}_trees_{modality_str}_{cfg.agglomoration.footprint}_{cfg.agglomoration.dist}.pkl", "wb") as f:
                pickle.dump(trees, f)
